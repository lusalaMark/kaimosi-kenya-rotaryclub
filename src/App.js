...
import ProjectSelection from "./components/pages/Committees";
    ...
    <>
      <Router>
        ...
        <Switch>
          ...
          <Route path="/committees" component={ProjectSelection} />
          <Route path="/events" component={Events} />
          <Route path="/contact-us" component={ContactUs} />
          <Route path="/joinus" component={JoinUs} />
          <Route path="/donate" component={Donate} />
          <Route path="/wearerotary" exact component={WeareRotary} />
